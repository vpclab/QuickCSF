...
SETTINGS_GROUP = [
	ConfigGroup('General settings',
		...
		Setting('Max wait time (s)',              float,   10,   helpText='In seconds'),
		...
		Setting('Monitor distance',   float,  57,        helpText='In cm'),
		...
		# Practice settings
		Setting('Eccentricities',               typing.List[float],        [4, 8, 12], helpText='In degrees'),
